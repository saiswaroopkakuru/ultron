...
def run_hook():
    ...
    Reduction tracks how repetitive the output is: on the benchmark fixtures,
    93% for build logs, 89% for diffs and 99% for JSON, and none for source code
    or short output, which pass through untouched.
    """
    try:
        raw = sys.stdin.read()
