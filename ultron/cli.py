...
def status():
    ...
    click.echo(f"  * Tokens Pruned (gross):      {telemetry['tokens_saved_gross']:,}")
    click.echo(f"  * Tokens Charged Back:        {telemetry['tokens_expanded']:,} (expansions)")
    click.echo(f"  * Tokens Saved (net):         {telemetry['tokens_saved']:,}")
